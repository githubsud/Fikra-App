...
export interface Comment { id: number; text: string; submission_date: Date; owner: User; }
export interface Idea { id: number; submission_date: Date; original_text: string; language: string; ai_classification: string; ai_enhanced_text: string; owner: User; comments: Comment[]; vote_count: number; tags: string | null; }
export interface SimilarIdea { id: number; original_text: string; similarity: number; }
